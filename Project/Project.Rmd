...
Reliance_on_Russian_imports <- as.data.frame(read_xlsx("Edited Data/Reliance on Russian imports.xlsx", sheet = "Reliance_Fuel"))

Gas_Trade_Flows <- as.data.frame(read_xlsx("Edited Data/Gas Trade Flows _17_02_2023.xlsx", sheet = "Data"))
