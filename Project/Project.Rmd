...
Monthly_Oil_Statistics <- Monthly_Oil_Statistics[,-102:-111]
...
=======
#France_Reliance_on_Russian_imports$Reliance <- as.numeric(France_Reliance_on_Russian_imports$Reliance)*100
#France_Reliance_on_Russian_imports$Reliance <- format(round(France_Reliance_on_Russian_imports$Reliance, 2), nsmall = 2)
#colnames(France_Reliance_on_Russian_imports) <- c("YEAR","COUNTRY","PRODUCT","Reliance %")


#Germany_Reliance_on_Russian_imports$Reliance <- as.numeric(Germany_Reliance_on_Russian_imports$Reliance)*100
#colnames(Germany_Reliance_on_Russian_imports) <- c("YEAR","COUNTRY","PRODUCT","Reliance %")
...
=======
The dates contained in this data set are in characters values so we need to change them int dates
```{r}
#Change Time
